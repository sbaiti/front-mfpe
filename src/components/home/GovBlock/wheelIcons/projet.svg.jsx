            ...
            <g>
                <g>
                    <rect
                        x="42.1"
                        y="32.7"
                        transform="matrix(0.9964 -8.453003e-02 8.453003e-02 0.9964 -2.6686 3.9144)"
            ...
            <g>
                <g>
                    <rect
                        x="43.4"
                        y="36.4"
                        transform="matrix(0.5729 -0.8197 0.8197 0.5729 -13.546 53.1275)"
                        className="fill-dark-blue"
                        width="1.6"
                        height="6.3"
                    />
            ...
            <g>
                <g>
                    <g>
                        <path
                            className="fill-dark-blue"
                            d="M35.1,11.2c-3.5,0.3-6.1,3.4-5.8,6.9c0.3,3.5,3.4,6.1,6.9,5.8c3.5-0.3,6.1-3.4,5.8-6.9
                ...
                <g>
                    <g>
                        <path
                            className="fill-dark-blue"
                            d="M23.2,32.2c-5.1-1.5-8-6.9-6.5-12c0.6-2,1.8-3.7,3.4-4.9l-1-1.3c-4.9,3.7-5.9,10.8-2.2,15.7
                ...
                <g>
                    <g>
                        <g>
                            <path
                                className="fill-dark-blue"
                                d="M65.6,15.3C65.6,15.3,65.6,15.3,65.6,15.3L65.6,15.3l-3.1-0.5c-0.4-0.1-0.7-0.5-0.7-0.9
                    ...
                    <g>
                        <g>
                            <rect
                                x="2.2"
                                y="19.1"
                                transform="matrix(0.9462 -0.3237 0.3237 0.9462 -6.1481 2.8623)"
                                className="fill-dark-blue"
                                width="6.6"
                                height="1.6"
                            />
                    ...
                    <g>
                        <g>
                            <rect
                                x="5.4"
                                y="9.6"
                                transform="matrix(0.5104 -0.86 0.86 0.5104 -8.1899 11.6706)"
                                className="fill-dark-blue"
                                width="1.6"
                                height="6.9"
                            />
                    ...
                    <g>
                        <g>
                            <rect
                                x="10.2"
                                y="5.7"
                                transform="matrix(0.9444 -0.3287 0.3287 0.9444 -2.3435 4.1232)"
                                className="fill-dark-blue"
                                width="1.6"
                                height="6.6"
                            />
